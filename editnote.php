...
if(isset($_POST['name'])) {
            ...
            $query = "UPDATE news SET name='".$_POST['name']."', sod='".$_POST['sod']."', tags='".$_POST['q']."', locked='".$_POST['locked']."', comments='".$_POST['comments']."' WHERE id='".$_GET['id']."'"; 
            ...
            for($j = 0;$j < $rows;$j++) {
                    ...
                    print('
                                    ...
                                    </div><div style="position:relative;"><div class="tolike tolike'.$id.'"><img src="icons8-love-100.png"></div>'.$hr.$h1_name.$divsod.$div.$divtags.$hr2.'</div><div class="likes"><div class="number"><span class="span"></div><div class="allinlikes">'.$divlike.'<span onclick="docom(\''.$id.'\')" class="commenty"><span class="comf" id="komnum"><span class="countcomf'.$id.'">'.$commentrows.'</span> Комментария</span><img src="https://png.icons8.com/metro/16/333333/topic.png" style="top:3px;">&nbsp;&nbsp;</span><span onclick="repostconfirm(\''.$id.'\')" class="repost"><span class="repf"><span class="countrepf">0</span> Репостов</span><img src="https://png.icons8.com/material/21/333333/refresh.png">&nbsp;&nbsp;</span><span class="edit" onclick="edit(\''.$id.'\')"><img src="https://png.icons8.com/windows/21/000000/pencil-tip.png"></span></span></div></div><br>');
