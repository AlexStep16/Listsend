...
<body>
    <div class="content">
        <div class="next">
            <a href="javascript:void(0)" style="cursor:default;">Для того, чтобы продолжить выберите не менее 3 интересующих вас категорий</a>
    ...
    if($rows>2) {
        ...
        $('.button').attr('onclick','location.href=\"choose2.php\"');</script>");
    }
    for($j=0;$j<$rows;$j++) {
        $result->data_seek($j);
