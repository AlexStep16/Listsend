...
<?php
    ...
    $query = "SELECT * from news WHERE id='".$mainlog."'"; 
    $result = $conn->query($query);
    $idblog = $mainlog;
    $mainlog = $result->fetch_array()['login'];
    ...
    $query = "SELECT * from news WHERE id='".$idblog."'"; 
    $result = $conn->query($query);
    ...
    <body style="background:#<?php echo $bgcolor; ?>">
        ...
        <div class="settings">
            ...
            <div class="content">
                ...
                <div class="design">
                    <div class="desbox">
                        <span>Заголовок</span>
                        <input type="text" id="deslogin" placeholder="Название блога" value='<?php echo $blogname; ?>' onkeydown="deslogin()">
                    </div>
                    <div class="desbox">
                        <span>Цитата блога</span>
                        <input type="text" id="description" value='<?php echo $description; ?>' placeholder="Что-нибудь хорошее" onkeydown="description()">
                    </div>
                    <div class="desbox">
                        <span>Описание блога</span>
                        <input type="text" id="description2" value='<?php echo $descript; ?>' placeholder="Напишите о чем блог" onkeydown="description2()">
                    </div>
                    <div class="desbox">
                    ...
                    <div class="desbox">
                        <span>Размер заголовка</span><input type="range" id="range" onmousemove="range()" value="<?php echo $blogsize; ?>" max="70" min="10"><input type="text" class="output" onkeydown="range2()">
                    </div>
                    <div class="desbox">
                        <span>Размер цитаты</span><input type="range" id="range2" onmousemove="range3()" value="<?php echo $descriptionsize; ?>" max="70" min="10"><input type="text" class="output2" onkeydown="range4()">
                    </div>
                    <div class="desbox">
        ...
        <div class="main">
            <div id="header">
                ...
                <a href="message.php">
                    <span style="position:relative;"><img src="https://png.icons8.com/windows/25/ffffff/sms.png"><?php echo $rows; ?></span><span class="headerspan"></span>
                </a>
            ...
            <div class="notifbox">
                <div class="noth1">Ваши уведомления <span>Показать все</span></div><hr>
                <ul>
            ...
            <div class="house">
                ...
                <div class="allbox">
                    ...
                    $result = $conn->query($query);
                    $rows = $result->num_rows;
                    print('<div class="subscribersline"><h2><img src="https://png.icons8.com/windows/20/999999/user-male-circle.png"> Читатели блога <span>'.$rows.'</span></h2><hr>');
                    for($j = 0;$j < $rows;$j++) { 
                        $result->data_seek($j);
                    ...
                    print('</div><br>');
                    $query = "SELECT * from news WHERE id='".$idblog."' AND reblog='' OR reblog='".$mainlog."' order by id DESC LIMIT 5"; 
                    $result = $conn->query($query);
                    $rows = $result->num_rows;
                for($j = 0;$j < $rows;$j++) {
                    $result->data_seek($j);
                    ...
                    if($del == 0) {
                        $divlike = '<span class="like like'.$id.'" onclick="like(\''.$id.'\'); changelike(\''.$id.'\');"><span class="likef likef'.$id.'"><span class="likefcount'.$id.'">'.$likes.'</span></span><span class=" imglike'.$id.'"><img src="https://png.icons8.com/windows/21/000000/hearts.png"></span>&nbsp;</span>';
                    }
                    # Если мой лайк стоит
                    else {
                        $divlike = '<span class="like like'.$id.'" onclick="like(\''.$id.'\'); changelike2(\''.$id.'\');"><span class="likef likef'.$id.'"><span class="likefcount'.$id.'">'.$likes.'</span></span><span class=" imglike'.$id.'"><img src="https://png.icons8.com/color/20/000000/filled-like.png"></span>&nbsp;</span>';
                    }
                    ...
                    print('
                            ...
                            print('
                                    ...
                                    </div><div style="position:relative;"><div class="tolike tolike'.$id.'"><img src="icons8-love-100.png"></div>'.$hr.$h1_name.$divsod.$div.$divtags.$hr2.'</div><div class="likes"><div class="number"><span class="span"></div><div class="allinlikes">'.$divlike.'<span onclick="docom(\''.$id.'\')" class="commenty"><span class="comf" id="komnum"><span class="countcomf'.$id.'">'.$commentrows.'</span></span><img src="https://png.icons8.com/metro/16/333333/topic.png" style="top:3px;">&nbsp;&nbsp;</span><span onclick="repostconfirm(\''.$id.'\')" class="repost"><span class="repf"><span class="countrepf">'.$repcount.'</span></span><img src="https://png.icons8.com/material/21/333333/refresh.png">&nbsp;&nbsp;</span></span></div></div><br>');
                if($_SESSION['email'] != 123313) {
                    ...
                    if($commentbool != 'true' || $mainlog == $_SESSION['login']) {
